        ...
        <div >
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sector">
                    <ContactItem icon={phone} text1={'+880 1883667962'} text2={'+880 1883667962'} title={"Phone"} />
                    <ContactItem icon={email} text1={'bluestacher11@gmail.com'} text2={'alikhanmohammadsajid@gmail.com'} title={"Email"}
                    />
                    <ContactItem icon={location} text1={'Bangladesh'} text2={'Chittagong, Raozan'} title={"Address"} />
                </div>
            </div>
